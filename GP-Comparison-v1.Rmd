...
ggplot(G_CompPlanProd, aes(Dates,value/1000000, col=variable)) + 
  geom_point() + 
  stat_smooth() +
...
```{r}
CompPlanProd$Difference <- (CompPlanProd$Actual_Production - CompPlanProd$Planned_Production)/1000000
CompPlanProdDiff <- CompPlanProd %>% select(Dates, Difference)
...
ggplot(G_CompProdCon, aes(Dates,value/1000000, col=variable)) + 
  geom_point() + 
  stat_smooth() +
  geom_line( color="grey") +
...
```{r}
CompProdCon$Difference <- (CompProdCon$Actual_Production - CompProdCon$Consumption)/1000000
CompProdConDiff <- CompProdCon %>% select(Dates, Difference)
